...
<div class="nav relative">
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="active">
                <a  href="<?php echo Yii::app()->createUrl('linkman');?>"> 联系人审核管理</a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade active in">
                <a class="btn <?php echo $active[0]?>" href="<?php echo Yii::app()->createUrl('linkman/create');?>">添加联系人</a>
                <a class="btn <?php echo $active[1]?>" href="<?php echo Yii::app()->createUrl('linkman');?>">联系人列表</a>
                <a class="btn <?php echo $active[2]?>" href="<?php echo Yii::app()->createUrl('linkman/excel');?>">导出联系人</a>
            </div>
