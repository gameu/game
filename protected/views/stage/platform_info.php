...
<div class="content lay-out">
	<div class="about-em"><!--关于运营商-->
		<div class="this-box">
			<div class="titles blue-b"><!-- 标题-->
				[n:info]
				<h2 class="left" title="49you"><i>$name</i><span> 游戏运营平台</span></h2>
			...
			<div class="box">
				...
				<div class="left-pro">
					...
					<div class="service">
						<a class="right" target="_blank" href="$url">【进入官网】</a>
		...
		<div class="this-box">
			...
			<div class="box border-box">
				<div class="employ-list">
					<dl>
						<dt>
							<a href="#"><img src="/logo_1365590121.jpg" alt="烈焰"></a>
						</dt>
						<dd>
							<p class="first">
								<a href="#">烈焰</a>
								<span><em>角色扮演</em></span>
							</p>
							<p>游戏开服：<b>6952</b>组</p>
							<p>平台开服：<b>323</b>组</p>
							<p>平台占比：
	...
	<div class="table new-pro mt_15"><!-- 新游推荐 表格开始 -->
		<div class="titles blue-b"><!-- 标题-->
			<h2 class="left" title="">49you <span>游戏列表</span></h2>
